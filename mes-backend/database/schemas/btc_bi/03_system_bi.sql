...
CREATE TABLE bi_data_quality_monitor (
    ...
    completeness_rate DECIMAL(5,2) DEFAULT 0 COMMENT '完整率',
    accuracy_rate DECIMAL(5,2) DEFAULT 0 COMMENT '准确率',
    consistency_rate DECIMAL(5,2) DEFAULT 0 COMMENT '一致率',
    validity_rate DECIMAL(5,2) DEFAULT 0 COMMENT '有效率',
    uniqueness_rate DECIMAL(5,2) DEFAULT 0 COMMENT '唯一率',
